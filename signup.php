...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-5  align" align="center" >
         <form action="code\insert.php" method="post" class="form-group space">

        <?php if(!isset($_SESSION['msg'])=='') echo $_SESSION['msg']; echo $_SESSION['msg']='';?>
               <h3>Create An Account</h3><br>

        <div class="">
          <input type="" name="firstname" class="" placeholder="first name" required="">
        </div>
        <div class="">
          <input type="" name="lastname" class="" placeholder="last name" required="">
        </div>
        <div class="">
          <input type="" name="email" class="" placeholder="email" required="">
        </div>
        <div class="">
          <input type="" name="password" class="" placeholder="password" required="">
        </div>
        <div class="">
          <input type="" name="" class="" placeholder="confirm password" required="">
        </div>
